...
#if defined(ILI9881D_CPT57_JIAKE_HD)
    &ili9881d_cpt57_jiake_hd_lcm_drv,
#endif
...
#if defined(ST7701S_CTC50_CHAOYUE_LFWVGA)
	&st7701s_ctc50_chaoyue_lfwvga_lcm_drv,
#endif

#if defined(ST7701S_CTC50_HONGZHAN_LFWVGA)
	&st7701s_ctc50_hongzhan_lfwvga_lcm_drv,
#endif

#if defined(ST7701S_BOE55_HONGZHAN_LFWVGA)
	&st7701s_boe55_hongzhan_lfwvga_lcm_drv,
#endif
#if defined(ST7703_IVO50_BRJ_LHD)
    &st7703_ivo50_brj_lhd_lcm_drv,
#endif
...
#if defined(JD9366D_PANDA57_HAIFEI_LHD720)
	&jd9366d_panda57_haifei_lhd720_lcm_drv,
#endif
