...
/* Vanzo:zhangxinyu on: Fri, 18 May 2018 17:17:14 +0800
 */
...
/* Vanzo:zhangxinyu on: Fri, 18 May 2018 17:16:27 +0800
    g_fg_battery_id = 0;
 */
    unsigned int Bat_id=0;
    Bat_id=gpio_get_value(356); //GPIO 13
    printk("Bat id = %d\n",Bat_id);
...
void fg_drv_update_hw_status(void)
{
	...
	bm_err("g_fg_battery_id: %d, car[%d,%ld,%ld,%ld,%ld] c:%d %d vbat:%d vbus:%d soc:%d %d gm3:%d %d %d %d\n",g_fg_battery_id,
